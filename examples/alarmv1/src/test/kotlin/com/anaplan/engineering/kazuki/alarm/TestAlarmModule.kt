...
import com.anaplan.engineering.kazuki.alarm.AlarmModule.numberOfExperts
...
class TestAlarmModule {
    ...
    val expert3 = mk_Expert(
        expertId3,
        mk_Set1(AlarmModule.Qualification.Bio, AlarmModule.Qualification.Chem, AlarmModule.Qualification.Elec)
    )
    ...
    val expert6 = mk_Expert(
        expertId6,
        mk_Set1(AlarmModule.Qualification.Elec, AlarmModule.Qualification.Chem, AlarmModule.Qualification.Bio,
            AlarmModule.Qualification.Mech)
    )
