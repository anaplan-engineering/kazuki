...
import com.anaplan.engineering.kazuki.ksp.type.property.toClassNameUnsafe
...
private fun TypeSpec.Builder.addMappingType(
    ...
    val superMappingTypeName = mappingType.toClassNameUnsafe().parameterizedBy(domainTypeName, rangeTypeName)
